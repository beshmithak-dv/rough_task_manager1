      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="text-center space-y-16 max-w-4xl w-full">
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
            ...
            <button className="w-full md:w-48 px-8 py-4 bg-blue-600 text-white rounded-lg text-xl font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200">
              Go to Dashboard
            </button>
          </div>
        </div>
