...
export function Signup({ onNavigate }: { onNavigate: (page: 'home' | 'login') => void }) {
        ...
        <div className="w-full max-w-md">
          <div className="text-center space-y-6 mb-10">
            ...
            <p className="text-lg text-white drop-shadow-md">
              Start your journey toward better task management.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-center">
              <p className="text-white drop-shadow-md">
                ...
                <button onClick={() => onNavigate('login')} className="font-semibold hover:text-white/80 transition-colors">
                  Login
                </button>
              </p>
            </div>
